...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                Console.WriteLine("The 'IsWeighted' value must be 'true' or 'false'. Please try again.");
                return;
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Types: 'Standard' - for standard grading, 'Ranked' - for ranked grading.");
            Console.WriteLine();
